...
public class Upload2 extends AppCompatActivity{
    ...
    public static final String PDF_UPLOAD_HTTP_URL = "https://modernmoodle.000webhostapp.com/AndroidJSon/sepm.php";
    ...
    public void AllowRunTimePermission(){
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(Upload2.this, Manifest.permission.READ_EXTERNAL_STORAGE))
        {

            Toast.makeText(Upload2.this,"READ_EXTERNAL_STORAGE permission Access Dialog", Toast.LENGTH_LONG).show();
