...
public class Upload4 extends AppCompatActivity{
    ...
    public void AllowRunTimePermission(){
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(Upload4.this, Manifest.permission.READ_EXTERNAL_STORAGE))
        {

            Toast.makeText(Upload4.this,"READ_EXTERNAL_STORAGE permission Access Dialog", Toast.LENGTH_LONG).show();
