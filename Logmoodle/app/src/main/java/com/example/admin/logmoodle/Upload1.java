...
public class Upload1 extends AppCompatActivity{
    ...
    public static final String PDF_UPLOAD_HTTP_URL = "https://modernmoodle.000webhostapp.com/AndroidJSon/toc.php";
    ...
    public void AllowRunTimePermission(){
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(Upload1.this, Manifest.permission.READ_EXTERNAL_STORAGE))
        {

            Toast.makeText(Upload1.this,"READ_EXTERNAL_STORAGE permission Access Dialog", Toast.LENGTH_LONG).show();
